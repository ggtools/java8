...
ENV JAVA8_UPDATE_NUMBER 60

# Install jre with tools.jar
RUN (curl -s -k -L -C - https://bintray.com/artifact/download/clabouisse/obuildfactory-generic-x86-64/jdk-1.8.0-openjdk-x86_64-1.8.0_u${JAVA8_UPDATE_NUMBER}.tar.xz | tar xfJ -) \
